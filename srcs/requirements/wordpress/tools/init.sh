...
if [ ! -f "${WP_DIR}/wp-config.php" ]; then
    ...
    docker exec wordpress wp config set WP_HOME "https://tkremnov.42.fr:8443" --path=/var/www/html --allow-root
    docker exec wordpress wp config set WP_SITEURL "https://tkremnov.42.fr:8443" --path=/var/www/html --allow-root
